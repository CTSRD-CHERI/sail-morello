...
definition uint_nondet  :: \<open> 'b Register_Value_class \<Rightarrow>(bitU)list \<Rightarrow>('b,(int),'a)monad \<close>  where 
     \<open> uint_nondet dict_Sail2_values_Register_Value_b v = (
  bools_of_bits_nondet 
  dict_Sail2_values_Register_Value_b v \<bind> ((\<lambda> bs . 
...
definition sint_nondet  :: \<open> 'b Register_Value_class \<Rightarrow>(bitU)list \<Rightarrow>('b,(int),'a)monad \<close>  where 
     \<open> sint_nondet dict_Sail2_values_Register_Value_b v = (
  bools_of_bits_nondet 
  dict_Sail2_values_Register_Value_b v \<bind> ((\<lambda> bs . 
...
definition int_of_vec_nondet  :: \<open> 'b Register_Value_class \<Rightarrow> bool \<Rightarrow>(bitU)list \<Rightarrow>('b,(int),'a)monad \<close>  where 
     \<open> int_of_vec_nondet dict_Sail2_values_Register_Value_b sign v = ( bools_of_bits_nondet 
  dict_Sail2_values_Register_Value_b v \<bind> ((\<lambda> v .  return (int_of_bools sign v))))\<close> 
  for  dict_Sail2_values_Register_Value_b  :: " 'b Register_Value_class " 
  and  sign  :: " bool " 
  and  v  :: "(bitU)list "
...
definition add_vec_bit_nondet  :: \<open> 'a Bitvector_class \<Rightarrow> 'd Register_Value_class \<Rightarrow> 'a \<Rightarrow> bitU \<Rightarrow>('d,'a,'c)monad \<close>  where 
     \<open> add_vec_bit_nondet dict_Sail2_values_Bitvector_a dict_Sail2_values_Register_Value_d l r = ( bool_of_bitU_nondet 
  dict_Sail2_values_Register_Value_d r \<bind> ((\<lambda> r .  return (add_vec_bool 
  dict_Sail2_values_Bitvector_a l r))))\<close> 
  for  dict_Sail2_values_Bitvector_a  :: " 'a Bitvector_class " 
  and  dict_Sail2_values_Register_Value_d  :: " 'd Register_Value_class " 
  and  l  :: " 'a " 
  and  r  :: " bitU "
...
definition adds_vec_bit_nondet  :: \<open> 'a Bitvector_class \<Rightarrow> 'd Register_Value_class \<Rightarrow> 'a \<Rightarrow> bitU \<Rightarrow>('d,'a,'c)monad \<close>  where 
     \<open> adds_vec_bit_nondet dict_Sail2_values_Bitvector_a dict_Sail2_values_Register_Value_d l r = ( bool_of_bitU_nondet 
  dict_Sail2_values_Register_Value_d r \<bind> ((\<lambda> r .  return (adds_vec_bool 
  dict_Sail2_values_Bitvector_a l r))))\<close> 
  for  dict_Sail2_values_Bitvector_a  :: " 'a Bitvector_class " 
  and  dict_Sail2_values_Register_Value_d  :: " 'd Register_Value_class " 
  and  l  :: " 'a " 
...
definition sub_vec_bit_nondet  :: \<open> 'a Bitvector_class \<Rightarrow> 'd Register_Value_class \<Rightarrow> 'a \<Rightarrow> bitU \<Rightarrow>('d,'a,'c)monad \<close>  where 
     \<open> sub_vec_bit_nondet dict_Sail2_values_Bitvector_a dict_Sail2_values_Register_Value_d  l r = ( bool_of_bitU_nondet 
  dict_Sail2_values_Register_Value_d r \<bind> ((\<lambda> r .  return (sub_vec_bool 
  dict_Sail2_values_Bitvector_a l r))))\<close> 
  for  dict_Sail2_values_Bitvector_a  :: " 'a Bitvector_class " 
  and  dict_Sail2_values_Register_Value_d  :: " 'd Register_Value_class " 
  and  l  :: " 'a " 
...
definition subs_vec_bit_nondet  :: \<open> 'a Bitvector_class \<Rightarrow> 'd Register_Value_class \<Rightarrow> 'a \<Rightarrow> bitU \<Rightarrow>('d,'a,'c)monad \<close>  where 
     \<open> subs_vec_bit_nondet dict_Sail2_values_Bitvector_a dict_Sail2_values_Register_Value_d l r = ( bool_of_bitU_nondet 
  dict_Sail2_values_Register_Value_d r \<bind> ((\<lambda> r .  return (subs_vec_bool 
  dict_Sail2_values_Bitvector_a l r))))\<close> 
  for  dict_Sail2_values_Bitvector_a  :: " 'a Bitvector_class " 
  and  dict_Sail2_values_Register_Value_d  :: " 'd Register_Value_class " 
  and  l  :: " 'a " 
...
\<comment> \<open>\<open>val mod_vec_nondet : forall 'rv 'e. Register_Value 'rv => list bitU -> list bitU -> monad 'rv (list bitU) 'e\<close>\<close>
...
definition mod_vec_nondet  :: \<open> 'rv Register_Value_class \<Rightarrow>(bitU)list \<Rightarrow>(bitU)list \<Rightarrow>('rv,((bitU)list),'e)monad \<close>  where 
     \<open> mod_vec_nondet dict_Sail2_values_Register_Value_rv l r = ( of_bits_nondet 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) dict_Sail2_values_Register_Value_rv (mod_vec l r))\<close> 
...
\<comment> \<open>\<open>val quot_vec_nondet : forall 'rv 'e. Register_Value 'rv => list bitU -> list bitU -> monad 'rv (list bitU) 'e\<close>\<close>
...
definition quot_vec_nondet  :: \<open> 'rv Register_Value_class \<Rightarrow>(bitU)list \<Rightarrow>(bitU)list \<Rightarrow>('rv,((bitU)list),'e)monad \<close>  where 
     \<open> quot_vec_nondet dict_Sail2_values_Register_Value_rv l r = ( of_bits_nondet 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) dict_Sail2_values_Register_Value_rv (quot_vec l r))\<close> 
  for  dict_Sail2_values_Register_Value_rv  :: " 'rv Register_Value_class " 
  and  l  :: "(bitU)list " 
  and  r  :: "(bitU)list "
...
\<comment> \<open>\<open>val quots_vec_nondet : forall 'rv 'e. Register_Value 'rv => list bitU -> list bitU -> monad 'rv (list bitU) 'e\<close>\<close>
...
definition quots_vec_nondet  :: \<open> 'rv Register_Value_class \<Rightarrow>(bitU)list \<Rightarrow>(bitU)list \<Rightarrow>('rv,((bitU)list),'e)monad \<close>  where 
     \<open> quots_vec_nondet dict_Sail2_values_Register_Value_rv l r = ( of_bits_nondet 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) dict_Sail2_values_Register_Value_rv (quots_vec l r))\<close> 
  for  dict_Sail2_values_Register_Value_rv  :: " 'rv Register_Value_class " 
  and  l  :: "(bitU)list " 
  and  r  :: "(bitU)list "
...
\<comment> \<open>\<open>val mod_vec_int_nondet : forall 'rv 'e. Register_Value 'rv => list bitU -> integer -> monad 'rv (list bitU) 'e\<close>\<close>
...
definition mod_vec_int_nondet  :: \<open> 'rv Register_Value_class \<Rightarrow>(bitU)list \<Rightarrow> int \<Rightarrow>('rv,((bitU)list),'e)monad \<close>  where 
     \<open> mod_vec_int_nondet dict_Sail2_values_Register_Value_rv l r = ( of_bits_nondet 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) dict_Sail2_values_Register_Value_rv (mod_vec_int l r))\<close> 
  for  dict_Sail2_values_Register_Value_rv  :: " 'rv Register_Value_class " 
  and  l  :: "(bitU)list " 
  and  r  :: " int "
...
\<comment> \<open>\<open>val quot_vec_int_nondet : forall 'rv 'e. Register_Value 'rv => list bitU -> integer -> monad 'rv (list bitU) 'e\<close>\<close>
...
definition quot_vec_int_nondet  :: \<open> 'rv Register_Value_class \<Rightarrow>(bitU)list \<Rightarrow> int \<Rightarrow>('rv,((bitU)list),'e)monad \<close>  where 
     \<open> quot_vec_int_nondet dict_Sail2_values_Register_Value_rv l r = ( of_bits_nondet 
  (instance_Sail2_values_Bitvector_list_dict
     instance_Sail2_values_BitU_Sail2_values_bitU_dict) dict_Sail2_values_Register_Value_rv (quot_vec_int l r))\<close> 
  for  dict_Sail2_values_Register_Value_rv  :: " 'rv Register_Value_class " 
  and  l  :: "(bitU)list " 
  and  r  :: " int "
...
definition duplicate_nondet  :: \<open> 'b Register_Value_class \<Rightarrow> bitU \<Rightarrow> int \<Rightarrow>('b,((bitU)list),'a)monad \<close>  where 
     \<open> duplicate_nondet dict_Sail2_values_Register_Value_b b n = (
  bool_of_bitU_nondet 
  dict_Sail2_values_Register_Value_b b \<bind> ((\<lambda> b . 
