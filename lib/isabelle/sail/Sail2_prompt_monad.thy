...
datatype( 'regval, 'a, 'e) monad =
  ...
  \<comment> \<open>\<open> Request to choose a (register) value, e.g. to resolve an undefined bit.
     The string argument may be used to provide information to the system
     about what the value is going to be used for. \<close>\<close>
  | Choose " string " " ('regval \<Rightarrow> ('regval, 'a, 'e) monad)"
...
\<comment> \<open>\<open>val choose_regval : forall 'rv 'e. string -> monad 'rv 'rv 'e\<close>\<close>
definition choose_regval  :: \<open> string \<Rightarrow>('rv,'rv,'e)monad \<close>  where 
     \<open> choose_regval descr = ( Choose descr return )\<close> 
  for  descr  :: " string "


\<comment> \<open>\<open>val choose_convert : forall 'rv 'e 'a. ('rv -> maybe 'a) -> string -> monad 'rv 'a 'e\<close>\<close>
definition choose_convert  :: \<open>('rv \<Rightarrow> 'a option)\<Rightarrow> string \<Rightarrow>('rv,'a,'e)monad \<close>  where 
     \<open> choose_convert of_rv descr = ( Choose descr ((\<lambda> rv .  maybe_fail descr (of_rv rv))))\<close> 
  for  of_rv  :: " 'rv \<Rightarrow> 'a option " 
  and  descr  :: " string "


\<comment> \<open>\<open>val choose_convert_default : forall 'rv 'e 'a. ('rv -> maybe 'a) -> 'a -> string -> monad 'rv 'a 'e\<close>\<close>
definition choose_convert_default  :: \<open>('rv \<Rightarrow> 'a option)\<Rightarrow> 'a \<Rightarrow> string \<Rightarrow>('rv,'a,'e)monad \<close>  where 
...
\<comment> \<open>\<open>val choose_bool : forall 'rv 'e. Register_Value 'rv => string -> monad 'rv bool 'e\<close>\<close>
definition choose_bool  :: \<open> 'rv Register_Value_class \<Rightarrow> string \<Rightarrow>('rv,(bool),'e)monad \<close>  where 
     \<open> choose_bool dict_Sail2_values_Register_Value_rv descr = ( choose_convert_default 
  (bool_of_regval_method   dict_Sail2_values_Register_Value_rv) False descr )\<close> 
  for  dict_Sail2_values_Register_Value_rv  :: " 'rv Register_Value_class " 
  and  descr  :: " string "


\<comment> \<open>\<open>val choose_bit : forall 'rv 'e. Register_Value 'rv => string -> monad 'rv bitU 'e\<close>\<close>
definition choose_bit  :: \<open> 'rv Register_Value_class \<Rightarrow> string \<Rightarrow>('rv,(bitU),'e)monad \<close>  where 
     \<open> choose_bit dict_Sail2_values_Register_Value_rv descr = ( bind (choose_bool 
  dict_Sail2_values_Register_Value_rv descr) ((\<lambda> b .  return (bitU_of_bool b))))\<close> 
  for  dict_Sail2_values_Register_Value_rv  :: " 'rv Register_Value_class " 
  and  descr  :: " string "


\<comment> \<open>\<open>val choose_int : forall 'rv 'e. Register_Value 'rv => string -> monad 'rv integer 'e\<close>\<close>
definition choose_int  :: \<open> 'rv Register_Value_class \<Rightarrow> string \<Rightarrow>('rv,(int),'e)monad \<close>  where 
     \<open> choose_int dict_Sail2_values_Register_Value_rv descr = ( choose_convert_default 
  (int_of_regval_method   dict_Sail2_values_Register_Value_rv)(( 0 :: int)) descr )\<close> 
  for  dict_Sail2_values_Register_Value_rv  :: " 'rv Register_Value_class " 
  and  descr  :: " string "


\<comment> \<open>\<open>val choose_real : forall 'rv 'e. Register_Value 'rv => string -> monad 'rv real 'e\<close>\<close>
definition choose_real  :: \<open> 'rv Register_Value_class \<Rightarrow> string \<Rightarrow>('rv,(real),'e)monad \<close>  where 
     \<open> choose_real dict_Sail2_values_Register_Value_rv descr = ( choose_convert_default 
  (real_of_regval_method   dict_Sail2_values_Register_Value_rv)(( 0 :: real)) descr )\<close> 
  for  dict_Sail2_values_Register_Value_rv  :: " 'rv Register_Value_class " 
  and  descr  :: " string "


\<comment> \<open>\<open>val choose_string : forall 'rv 'e. Register_Value 'rv => string -> monad 'rv string 'e\<close>\<close>
definition choose_string  :: \<open> 'rv Register_Value_class \<Rightarrow> string \<Rightarrow>('rv,(string),'e)monad \<close>  where 
     \<open> choose_string dict_Sail2_values_Register_Value_rv descr = ( choose_convert_default 
  (string_of_regval_method   dict_Sail2_values_Register_Value_rv) (''default'') descr )\<close> 
  for  dict_Sail2_values_Register_Value_rv  :: " 'rv Register_Value_class " 
  and  descr  :: " string "


\<comment> \<open>\<open>val headM : forall 'rv 'a 'e. list 'a -> monad 'rv 'a 'e\<close>\<close>
definition headM  :: \<open> 'a list \<Rightarrow>('rv,'a,'e)monad \<close>  where 
     \<open> headM = ( (\<lambda>x .  
  (case  x of   x # _ => return x | [] => Fail (''headM'') )))\<close>


\<comment> \<open>\<open>val tailM : forall 'rv 'a 'e. list 'a -> monad 'rv (list 'a) 'e\<close>\<close>
definition tailM  :: \<open> 'a list \<Rightarrow>('rv,('a list),'e)monad \<close>  where 
     \<open> tailM = ( (\<lambda>x .  
